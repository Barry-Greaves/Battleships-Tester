    ...
    def place_ships(self):
        for i in range(self.num_ships):
            ...
            while not placed:
                ...
                if self.hidden_board[row][col] == "O":
...
def main():
    print("Welcome to Battleships! In this game, you will try to sink the computer's battleships by entering the row and column of the grid you want to attack. The computer will do the same to your battleships. The first player to sink all of the other player's battleships wins. Good luck!")
